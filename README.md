...
Вместо вывода по 12 вывожу по 3 для наглядности. Как понял пагинацию при изменении фильтра нужно сохранять на том-же пункте. Если стояло на пункте, который больше чем есть в новом фильтре, то ставиться на первую страницу.
